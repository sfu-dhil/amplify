...
- A copy of the `amplify.sql` database sql file. If you are not sure what these are or where to get them, you should contact the [Digital Humanities Innovation Lab](mailto:dhil@sfu.ca) for access. This file should be placed in the root folder.
...
## Download missing media files (from bad imports)

    docker exec -it amplify_app ./bin/console app:media:missing:download
