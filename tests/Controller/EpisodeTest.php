...
class EpisodeTest extends ControllerBaseCase {
    ...
    public function testAdminEdit() {
        ...
        'episode[number]' => 'Updated Number',
            ...
            'episode[references]' => 'Updated Biblography',
        ...
        $this->assertEquals(1, $responseCrawler->filter('td:contains("Updated Number")')->count());
            $this->assertEquals(1, $responseCrawler->filter('td:contains("Updated Preserved")')->count());
            ...
            $this->assertEquals(1, $responseCrawler->filter('td:contains("Updated Biblography")')->count());
    ...
    public function testAdminNew() {
        ...
        'episode[number]' => 'New Number',
            ...
            'episode[references]' => 'New Biblography',
        ...
        $this->assertEquals(1, $responseCrawler->filter('td:contains("New Number")')->count());
            $this->assertEquals(1, $responseCrawler->filter('td:contains("New Preserved")')->count());
            ...
            $this->assertEquals(1, $responseCrawler->filter('td:contains("New Biblography")')->count());
