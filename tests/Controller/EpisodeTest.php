...
class EpisodeTest extends ControllerBaseCase {
    ...
    public function testAdminEdit() : void {
        ...
        $this->assertSame(1, $responseCrawler->filter('td:contains("Updated Language")')->count());
        $this->assertSame(1, $responseCrawler->filter('td:contains("Updated Tags")')->count());
        $this->assertSame(1, $responseCrawler->filter('td:contains("Updated References")')->count());
    ...
    public function testAdminNew() : void {
        ...
        $this->assertSame(1, $responseCrawler->filter('td:contains("New Language")')->count());
        $this->assertSame(1, $responseCrawler->filter('td:contains("New Tags")')->count());
        $this->assertSame(1, $responseCrawler->filter('td:contains("New References")')->count());
