...
class PersonTest extends ControllerBaseCase {
    ...
    public function testAdminEdit() : void {
        ...
        $this->assertSame(1, $responseCrawler->filter('td:contains("Updated Affiliation")')->count());
    ...
    public function testAdminNew() : void {
        ...
        $this->assertSame(1, $responseCrawler->filter('td:contains("New Affiliation")')->count());
